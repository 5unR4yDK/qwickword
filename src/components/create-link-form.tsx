...
/**
 * The core create-link flow. Redesigned 2026-07-21 per the maintainer (interactive)
 ...
 *
 * On success the link is copied to the clipboard automatically (the maintainer:
