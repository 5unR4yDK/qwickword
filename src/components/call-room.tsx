 ...
 * "over 50%," per the maintainer's own phrasing, which is why exactly 2 of 2 is
...
export default function CallRoom({
  ...
  // countdown" (2026-07-22, the maintainer, interactive). Set once CallMedia
  ...
  // (the maintainer, interactive: "when I start the meeting the first seconds
  ...
  // before this one did) — AND, as of 2026-07-22 (the maintainer, interactive, live
  ...
  // once the countdown has actually started (added 2026-07-22, the maintainer,
  ...
  // Extended 2026-07-22 (the maintainer, interactive, live bug: after leaving a
  ...
  return (
    <>
      {hasLeft ? (
        ...
        // more countdown" (2026-07-22, the maintainer, interactive). Replaces
