...
//
// Extended 2026-07-22 (the maintainer, interactive, after trying the first version
...
// corner where the maintainer found it "very close to the edge of the browser" and
...
// their camera off, not that the video failed — the maintainer: "there's no
// monogram or any indication... I think there has to be something to
// indicate that it's just the video is off."
//
// Screen share (the maintainer: "we also need to be able to share screen like in
...
// box's own aspect ratio. the maintainer caught the real consequence of that
  ...
  return (
    <div className="absolute inset-0 bg-black">
      {showAvatar ? (
        ...
        // fit="contain" (was "cover") — 2026-07-22, the maintainer, interactive:
          ...
          {cameraIds.map((id) => (
            ...
            >
              {/* fit="contain" (was "cover") — same "never crop" rule
                  ...
                  camera feed in this file, per the maintainer: "that goes both on
